...
describe("AddReviewService", () => {
    ...
    beforeEach(async () => {
        ...
        reviewRepository = addReviewService["reviewRepository"] as InMemoryReviewRepository;
        bookRepository = addReviewService["bookRepository"] as InMemoryBookRepository;
    });
